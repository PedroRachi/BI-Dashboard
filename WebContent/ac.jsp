...
<script type="text/javascript">
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
				...
				[ 'Combustiveis', 71, 62, 11 ],
				[ 'Estacionamento', 90, 70, 20 ],
				[ 'Supermercado', 75, 59, 26 ], 
				[ 'Hotel', 42, 28, 14 ] ]);
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
				[ "Software House", "Faturamento", {
					role : "style"
				} ], [ "Santos Ltda", 15433, "#b87333" ],
				[ "Mesquita Ltda", 13416, "#6495ED" ],
				[ "Oxê Tecnologia", 6254, "#008B8B" ],
				[ "Signus", 1221, "#ff1a1a" ],
				[ "Salva Tech", 11152, "#FF4500" ] ]);
