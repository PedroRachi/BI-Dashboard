...
<script type="text/javascript">
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
				...
				[ 'Combustiveis', 52, 37, 15 ],
				[ 'Estacionamento', 77, 65, 12 ],
				[ 'Supermercado', 47, 33, 14 ], [ 'Hotel', 60, 50, 10 ] ]);
	...
	function drawChart() {
		var data = google.visualization.arrayToDataTable([
				[ "Software House", "Faturamento", {
					role : "style"
				} ], [ "Anselmo Ltda", 12416, "#6495ED" ],
				[ "Parana Inc", 13254, "#008B8B" ],
				[ "Coxa Tech", 11485, "#ff1a1a" ],
				[ "Lima Ltda", 13254, "#FF4500" ] ]);
